...
![tokenHub](/web/default/public/logo.png)
...
<p align="center">
  <a href="https://raw.githubusercontent.com/Calcium-Ion/tokenHub/main/LICENSE">
    <img src="https://img.shields.io/github/license/Calcium-Ion/tokenHub?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/Calcium-Ion/tokenHub/releases/latest">
    <img src="https://img.shields.io/github/v/release/Calcium-Ion/tokenHub?color=brightgreen&include_prereleases" alt="version">
  </a><!--
  --><a href="https://hub.docker.com/r/CalciumIon/tokenHub">
    <img src="https://img.shields.io/badge/docker-dockerHub-blue" alt="docker">
  </a><!--
  --><a href="https://goreportcard.com/report/github.com/Calcium-Ion/tokenHub">
    <img src="https://goreportcard.com/badge/github.com/Calcium-Ion/tokenHub" alt="GoReportCard">
  </a>
</p>
...
<p align="center">
  ...
  --><a href="https://www.producthunt.com/products/tokenHub/launches/tokenHub?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-tokenHub" target="_blank" rel="noopener noreferrer">
    <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1047693&theme=light&t=1769577875005" alt="Token Hub - All-in-one AI asset management gateway. | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" />
  </a>
</p>
...
<p align="center">
  <a href="https://www.jetbrains.com/?from=tokenHub" target="_blank">
    <img src="https://resources.jetbrains.com/storage/products/company/brand/logos/jb_beam.png" alt="JetBrains Logo" width="120" />
  </a>
</p>

<p align="center">
  <strong>Merci à <a href="https://www.jetbrains.com/?from=tokenHub">JetBrains</a> pour avoir fourni une licence de développement open-source gratuite pour ce projet</strong>
</p>
...
docker pull calciumion/tokenHub:latest

# Utilisation de SQLite (par défaut)
docker run --name tokenHub -d --restart always \
  -p 3000:3000 \
  -e TZ=Asia/Shanghai \
  -v ./data:/data \
  calciumion/tokenHub:latest
...
### 📖 [Documentation officielle](https://docs.newapi.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/elesos/tokenHub)
...
- 🔍 Requête de quota d'utilisation de clé (avec [tokenHub-key-tool](https://github.com/Calcium-Ion/tokenHub-key-tool))
...
> [!TIP]
> **Dernière image Docker:** `calciumion/tokenHub:latest`
...
| `PYROSCOPE_APP_NAME` | Nom de l'application Pyroscope | `tokenHub` |
...
| `HOSTNAME` | Nom d'hôte tagué pour Pyroscope | `tokenHub` |
...
| Projet | Description |
|------|------|
| [tokenHub-key-tool](https://github.com/Calcium-Ion/tokenHub-key-tool) | Outil de recherche de quota d'utilisation avec une clé |
| [tokenHub-horizon](https://github.com/Calcium-Ion/tokenHub-horizon) | Version optimisée haute performance de Token Hub |
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=Calcium-Ion/tokenHub&type=Date)](https://star-history.com/#Calcium-Ion/tokenHub&Date)
...
### 💖 Merci d'utiliser Token Hub

Si ce projet vous est utile, bienvenue à nous donner une ⭐️ Étoile！

**[Documentation officielle](https://docs.newapi.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/Calcium-Ion/tokenHub/issues)** • **[Dernière version](https://github.com/Calcium-Ion/tokenHub/releases)**

<sub>Construit avec ❤️ par elesos</sub>
