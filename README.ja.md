...
<p align="center">
  <a href="https://raw.githubusercontent.com/Calcium-Ion/tokenHub/main/LICENSE">
    <img src="https://img.shields.io/github/license/Calcium-Ion/tokenHub?color=brightgreen" alt="license">
  </a><!--
  --><a href="https://github.com/Calcium-Ion/tokenHub/releases/latest">
    <img src="https://img.shields.io/github/v/release/Calcium-Ion/tokenHub?color=brightgreen&include_prereleases" alt="release">
  </a><!--
...
<p align="center">
  <strong>感謝 <a href="https://www.jetbrains.com/?from=tokenHub">JetBrains</a> が本プロジェクトに無料のオープンソース開発ライセンスを提供してくれたことに感謝します</strong>
</p>
...
### 📖 [公式ドキュメント](https://docs.newapi.pro/ja/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/elesos/tokenHub)
...
- 📱 Telegram認証ログイン
- 🔑 OIDC統一認証
- 🔍 Key使用量クォータ照会（[tokenHub-key-tool](https://github.com/Calcium-Ion/tokenHub-key-tool)と併用）
...
> [!TIP]
> **最新のDockerイメージ:** `calciumion/tokenHub:latest`
...
| `PYROSCOPE_APP_NAME` | Pyroscopeアプリ名 | `tokenHub` |
...
| `HOSTNAME` | Pyroscope用のホスト名タグ | `tokenHub` |
...
| プロジェクト | 説明 |
|------|------|
| [tokenHub-key-tool](https://github.com/Calcium-Ion/tokenHub-key-tool) | キー使用量クォータ照会ツール |
| [tokenHub-horizon](https://github.com/Calcium-Ion/tokenHub-horizon) | New API高性能最適化版 |
...
[![スター履歴チャート](https://api.star-history.com/svg?repos=Calcium-Ion/tokenHub&type=Date)](https://star-history.com/#Calcium-Ion/tokenHub&Date)
...
**[公式ドキュメント](https://docs.newapi.pro/ja/docs)** • **[問題フィードバック](https://github.com/Calcium-Ion/tokenHub/issues)** • **[最新リリース](https://github.com/Calcium-Ion/tokenHub/releases)**

<sub>❤️ で構築された elesos</sub>
