...
<p align="center">
  <strong>Thanks to <a href="https://www.jetbrains.com/?from=tokenHub">JetBrains</a> for providing free open-source development license for this project</strong>
</p>
...
- 🔍 Key quota query usage (with [tokenHub-key-tool](https://github.com/Calcium-Ion/tokenHub-key-tool))
...
> [!TIP]
> **Latest Docker image:** `calciumion/tokenHub:latest`
...
| `PYROSCOPE_APP_NAME` | Pyroscope application name | `tokenHub` |
| `PYROSCOPE_BASIC_AUTH_USER` | Pyroscope basic auth user | - |
| `PYROSCOPE_BASIC_AUTH_PASSWORD` | Pyroscope basic auth password | - |
| `PYROSCOPE_MUTEX_RATE` | Pyroscope mutex sampling rate | `5` |
| `PYROSCOPE_BLOCK_RATE` | Pyroscope block sampling rate | `5` |
| `HOSTNAME` | Hostname tag for Pyroscope | `tokenHub` |
...
| Project | Description |
|------|------|
| [tokenHub-key-tool](https://github.com/Calcium-Ion/tokenHub-key-tool) | Key quota query tool |
| [tokenHub-horizon](https://github.com/Calcium-Ion/tokenHub-horizon) | Token Hub high-performance optimized version |
...
the author attribution notice `Frontend design and development by Token Hub
