...
<p align="center">
  <strong>感谢 <a href="https://www.jetbrains.com/?from=tokenHub">JetBrains</a> 为本项目提供免费的开源开发许可证</strong>
</p>
...
### 📖 [官方文档](https://docs.newapi.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/tokenHub)
...
- 📱 Telegram 授权登录
- 🔑 OIDC 统一认证
- 🔍 Key 查询使用额度（配合 [tokenHub-key-tool](https://github.com/Calcium-Ion/tokenHub-key-tool)）
...
> [!TIP]
> **最新版 Docker 镜像：** `calciumion/tokenHub:latest`
...
| 项目 | 说明 |
|------|------|
| [tokenHub-key-tool](https://github.com/Calcium-Ion/tokenHub-key-tool) | Key 额度查询工具 |
| [tokenHub-horizon](https://github.com/Calcium-Ion/tokenHub-horizon) | Token Hub 高性能优化版 |
...
[![Star History Chart](https://api.star-history.com/svg?repos=Calcium-Ion/tokenHub&type=Date)](https://star-history.com/#Calcium-Ion/tokenHub&Date)
...
**[官方文档](https://docs.newapi.pro/zh/docs)** • **[问题反馈](https://github.com/Calcium-Ion/tokenHub/issues)** • **[最新发布](https://github.com/Calcium-Ion/tokenHub/releases)**
