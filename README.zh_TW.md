...
<p align="center">
  <strong>感謝 <a href="https://www.jetbrains.com/?from=tokenHub">JetBrains</a> 為本項目提供免費的開源開發許可證</strong>
</p>
...
### 📖 [官方文件](https://docs.newapi.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/tokenHub)
...
- 📱 Telegram 授權登錄
- 🔑 OIDC 統一認證
- 🔍 Key 查詢使用額度（配合 [tokenHub-key-tool](https://github.com/Calcium-Ion/tokenHub-key-tool)）
...
> [!TIP]
> **最新版 Docker 鏡像：** `calciumion/tokenHub:latest`
...
| `PYROSCOPE_APP_NAME` | Pyroscope 應用名                                        | `tokenHub` |
...
| `HOSTNAME` | Pyroscope 標籤裡的主機名                                          | `tokenHub` |
...
| 項目 | 說明 |
|------|------|
| [tokenHub-key-tool](https://github.com/Calcium-Ion/tokenHub-key-tool) | Key 額度查詢工具 |
| [tokenHub-horizon](https://github.com/Calcium-Ion/tokenHub-horizon) | Token Hub 高性能優化版 |
...
**[官方文件](https://docs.newapi.pro/zh/docs)** • **[問題回饋](https://github.com/Calcium-Ion/tokenHub/issues)** • **[最新發布](https://github.com/Calcium-Ion/tokenHub/releases)**
