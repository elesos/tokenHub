# Token Hub Electron Desktop App

This directory contains the Electron wrapper for Token Hub, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., tokenHub-macos)
cp ../tokenHub-macos ../tokenHub
```
...
- Store database in `../data/tokenHub.db`
...
### Database Location
- **Development**: `../data/tokenHub.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Token Hub/data/`
  - Windows: `%APPDATA%/Token Hub/data/`
  - Linux: `~/.config/Token Hub/data/`
