...
func main() {
	...
	common.SysLog("Token Hub " + common.Version + " started")
	...
	server.Use(gin.CustomRecovery(func(c *gin.Context, err any) {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": gin.H{
				"message": fmt.Sprintf("Panic detected, error: %v. Please submit a issue here: https://github.com/Calcium-Ion/tokenHub", err),
				"type":    "new_api_panic",
			},
		})
	}))
