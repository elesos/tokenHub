...
import (
	...
	"github.com/QuantumNous/tokenHub/relay/channel/ai360"
	"github.com/QuantumNous/tokenHub/relay/channel/lingyiwanwu"

	//"github.com/QuantumNous/tokenHub/relay/channel/minimax"
	"github.com/QuantumNous/tokenHub/relay/channel/openrouter"
	"github.com/QuantumNous/tokenHub/relay/channel/xinference"
	relaycommon "github.com/QuantumNous/tokenHub/relay/common"
	"github.com/QuantumNous/tokenHub/relay/common_handler"
	...
	"github.com/QuantumNous/tokenHub/setting/reasoning"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		...
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "Token Hub")
		}
	}
	return nil
}
