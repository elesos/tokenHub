...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-tokenHub-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-tokenHub-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-tokenHub-container') return true;
      return (
